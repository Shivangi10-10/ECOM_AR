...
import 'package:shivangi/api_consumer.dart';
  ...
  validateUploadFormAndUploadItemInfo() async
  {
    if(imageFileUint8List != null)
    {
          ...
          && itemPriceTextEditingController.text.isNotEmpty )
      {
        ...
        fStorage.Reference firebaseStorageRef = fStorage.FirebaseStorage.instance.ref().child("Item Images").child(imageUniqueName);
